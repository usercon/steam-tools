...
> [!IMPORTANT]
> * 💡 execution url is `steamcommunity.com/<userID>/groups`

![Preview](/img/group-finder.png)
...
> [!NOTE]
> * auto-scrolls pages and detects apps that contain one or more letters from a specific language, in their title
> * right now script seaching for chinese titles
> * check the language regex structure and comment out to include other languages

> [!IMPORTANT]
> * 💡 execution url is `store.steampowered.com/search`
> * 💡 infinite scroll **MUST** be **Enabled** `store.steampowered.com/account/preferences`

![Preview](/img/game-filter.png)
...
> * works with `backgrounds` `emoticons` and `trading cards`

> [!IMPORTANT]
> * 💡 execution url is `steamcommunity.com/market/<item>`
